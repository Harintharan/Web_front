...
export default function AddDoner() {
  ...
  const onSubmit=async (e)=>{
    ...
    let submit=true;
    if(!identy_number||  !first_name || !last_name || !age || !blood_group || !district_name || !contact_number)
    {
      alert("must fill id,f_N ,L_N,age,B.G,District,C.N");
    }
      ...
      if (
        alldoners.find(
          (alldoners) =>
            alldoners.identy_number === doner.identy_number
  ...
  return (
    <div>
      ...
      <div className="Home-custom-backgroundAEA custom-formAE custom-labelA2E">
    <div className="container ">
      <diV className="row">
        <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow custom-formAE  ">
        <h2 className="text-center m-4">Register Doner</h2>
